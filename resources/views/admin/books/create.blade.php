...
@section('title','Thêm')
@section('content')
<form role="form" method="POST" action="{{ route('admin.book.store') }}" enctype="multipart/form-data"  onsubmit="return requestBook()">
    @csrf
    <div class="row">
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input  type="hidden" id="genres" name="genres" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Tác giả </label>
                        <select id="author_id" name="author_id" class="form-control">
                            ...
                            @foreach ($authors as $author)
                                <option class="author_id_data" value='{{ $author->id }}'>{{ $author->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="accent_id" name="accent_id" class="form-control">
                            ...
                            @foreach ($accents as $accent)
                                <option class="accent_id_data" value='{{ $accent->id }}'>{{ $accent->name }}</option>
                            @endforeach
                        </select>
